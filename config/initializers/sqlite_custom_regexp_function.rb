...
# AbstractAdapter class represents a connection to the database and provides an
# abstract interface for database-specific functionality such as establishing a connection, escaping values
